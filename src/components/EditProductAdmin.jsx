...
const EditProductAdmin = ({close, data: propsData, fetchProductData}) => {
  ...
  return (
    <section className="fixed top-0 left-0 right-0 bottom-0 bg-black bg-opacity-50 p-4 z-50">
        ...
        <section>
          ...
          <div className="grid gap-2 p-3">
            <form className="grid gap-4" onSubmit={handleSubmit}>
                  ...
                  <div className="flex flex-wrap gap-4">
                    {data.image.map((img, index) => {
                      return (
                        <div
                          key={img + index}
                          className="h-20 w-20 min-w-20 my-1 bg-blue-50 border relative cursor-pointer group"
                        >
                          <img
                            src={img}
                            alt={img}
              ...
              <button onClick={handleSubmit} className="bg-primary-100 hover:bg-primary-200 py-2 rounded font-semibold">
                Update Product
              </button>
            </form>
          </div>
